...
export const inventory_statusList = [
  "InStock",
  "ComingSoon",
  "DoneForTheSeason",
];

export const inventory_productTypes = [
  { category: "Cherry", type: "Fruit" },
  { category: "Plum", type: "Fruit" },
  { category: "Apricot", type: "Fruit" },
  { category: "Eggs", type: "Dairy" },
];
